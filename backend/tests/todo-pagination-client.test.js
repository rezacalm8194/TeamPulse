...
test('client assets are consistently bumped to tp162', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp162'/);
  assert.match(app, /team-pulse-static-v162/);
  assert.match(html, /app\.js\?v=tp162/);
  assert.match(sw, /team-pulse-static-v162/);
});
