...
test('client assets are consistently bumped to tp157', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp157'/);
  assert.match(app, /team-pulse-static-v157/);
  assert.match(html, /app\.js\?v=tp157/);
  assert.match(sw, /team-pulse-static-v157/);
});
