...
test('client assets are consistently bumped to tp146', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp146'/);
  assert.match(app, /team-pulse-static-v146/);
  assert.match(html, /app\.js\?v=tp146/);
  assert.match(sw, /team-pulse-static-v146/);
});
