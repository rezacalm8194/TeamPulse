...
test('client assets are consistently bumped to tp160', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp160'/);
  assert.match(app, /team-pulse-static-v160/);
  assert.match(html, /app\.js\?v=tp160/);
  assert.match(sw, /team-pulse-static-v160/);
});
