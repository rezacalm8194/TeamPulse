...
test('client assets are consistently bumped to tp148', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp148'/);
  assert.match(app, /team-pulse-static-v148/);
  assert.match(html, /app\.js\?v=tp148/);
  assert.match(sw, /team-pulse-static-v148/);
});
