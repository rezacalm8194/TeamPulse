...
test('client assets are consistently bumped to tp159', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp159'/);
  assert.match(app, /team-pulse-static-v159/);
  assert.match(html, /app\.js\?v=tp159/);
  assert.match(sw, /team-pulse-static-v159/);
});
