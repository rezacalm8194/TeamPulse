...
test('client assets are consistently bumped to tp153', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp153'/);
  assert.match(app, /team-pulse-static-v153/);
  assert.match(html, /app\.js\?v=tp153/);
  assert.match(sw, /team-pulse-static-v153/);
});
