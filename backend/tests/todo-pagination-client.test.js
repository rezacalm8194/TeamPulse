...
test('client assets are consistently bumped to tp142', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp142'/);
  assert.match(app, /team-pulse-static-v142/);
  assert.match(html, /app\.js\?v=tp142/);
  assert.match(sw, /team-pulse-static-v142/);
});
