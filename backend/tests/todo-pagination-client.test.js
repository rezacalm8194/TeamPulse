...
test('client assets are consistently bumped to tp147', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp147'/);
  assert.match(app, /team-pulse-static-v147/);
  assert.match(html, /app\.js\?v=tp147/);
  assert.match(sw, /team-pulse-static-v147/);
});
