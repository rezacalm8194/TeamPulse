...
test('client assets are consistently bumped to tp158', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp158'/);
  assert.match(app, /team-pulse-static-v158/);
  assert.match(html, /app\.js\?v=tp158/);
  assert.match(sw, /team-pulse-static-v158/);
});
