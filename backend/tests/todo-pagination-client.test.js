...
test('client assets are consistently bumped to tp145', () => {
  assert.match(app, /TP_ASSET_V\s*=\s*'tp145'/);
  assert.match(app, /team-pulse-static-v145/);
  assert.match(html, /app\.js\?v=tp145/);
  assert.match(sw, /team-pulse-static-v145/);
});
